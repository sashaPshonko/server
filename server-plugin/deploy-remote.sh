...
rm -f "${PLUGINS}"/PveAuction-0.1.0.jar "${PLUGINS}"/PveAuction-0.1.1.jar 2>/dev/null || true
...
echo ""
echo "Готово. В игре: /shop — в чате «сборка 0.1.2», в заголовке окна «Скупка [0.1.2]»."
